...
export function registerResources(vscodeContext: ExtensionContext) {
    ...
    Resources.icons.set('warning', Uri.file(vscodeContext.asAbsolutePath(path.join('resources', 'bitbucket', 'warning.svg'))));
    ...
    Resources.icons.set('pending', Uri.file(vscodeContext.asAbsolutePath(path.join('resources', 'pipelines', 'icon-pending.svg'))));
    Resources.icons.set('building', Uri.file(vscodeContext.asAbsolutePath(path.join('resources', 'pipelines', 'icon-building.svg'))));
    Resources.icons.set('success', Uri.file(vscodeContext.asAbsolutePath(path.join('resources', 'pipelines', 'icon-success.svg'))));
    Resources.icons.set('failed', Uri.file(vscodeContext.asAbsolutePath(path.join('resources', 'pipelines', 'icon-failed.svg'))));
    Resources.icons.set('stopped', Uri.file(vscodeContext.asAbsolutePath(path.join('resources', 'pipelines', 'icon-stopped.svg'))));
    Resources.icons.set('paused', Uri.file(vscodeContext.asAbsolutePath(path.join('resources', 'pipelines', 'icon-paused.svg'))));
