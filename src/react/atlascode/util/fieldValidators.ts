...
export function validateUrl(name: string, value?: string): string | undefined {
    return value !== undefined && rUrl.test(value) ? undefined : `${name} must be a valid URL`;
}
...
export function validateEmail(name: string, value?: string): string | undefined {
    return value !== undefined && rEmail.test(value) ? undefined : `${name} must be a valid email address`;
}
