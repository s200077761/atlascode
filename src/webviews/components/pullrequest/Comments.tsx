            ...
            <CommentComponent
                ...
                edited={
                    ...
                    differenceInSeconds(this.props.node.updatedTs, this.props.node.ts) > 1 && (
                        <CommentEdited>{`${this.editedOrDeleted()} ${distanceInWordsToNow(
                            this.props.node.updatedTs
                        )} ago`}</CommentEdited>
                    )
                }
                content={
...
> {
    ...
    render(): any {
        return (
            <div style={{ width: '100%', marginLeft: 8, marginTop: 10 }}>
                <textarea
                ...
                />
                <ButtonGroup>
                    <Button className="ac-button" onClick={this.handleEditSubmit}>
                        Save Changes
                    </Button>
