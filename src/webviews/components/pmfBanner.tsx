...
const q2 = { id: "q2", question: "How can we improve this add-on for you?" };
    ...
    render() {
        ...
        return (
            <div>
                <SectionMessage
                    appearance="change"
                    title="Take a quick survey to let us know how we're doing"
                >
                    <div>
                        <ButtonGroup>
                            <Button className='ac-button' onClick={this.handleOpen}>Take Survey</Button>
                            <Button className='ac-banner-link-button' appearance="link" onClick={this.handleLater}>Maybe Later</Button>
                            <Button className='ac-banner-link-button' appearance="link" onClick={this.handleNever}>No Thanks</Button>
                        </ButtonGroup>
                    </div>
                </SectionMessage>
                            ...
                            >
                                {(frmArgs: any) => {
                                    return (<form {...frmArgs.formProps}>
                                        <Field label={q1.question} isRequired={false} id="q1" name="q1" value={this.state.q1Value} validate={FieldValidators.validateMultiSelect} >
                                            {
                                                (fieldArgs: any) => {
