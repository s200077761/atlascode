...
export default class DisplayFeedback extends React.Component<
    { userDetails: FeedbackUser; onFeedback: (feedback: FeedbackData) => void },
    MyState
> {
    ...
    render() {
        ...
        return (
            <div>
                ...
                {isOpen && (
                    <ModalTransition>
                        <Modal onClose={this.handleClose} heading="Send Feedback" shouldCloseOnEscapePress={false}>
                            <Form name="feedback-collector" onSubmit={this.handleFeedback}>
                                {(frmArgs: any) => {
                                    return (
