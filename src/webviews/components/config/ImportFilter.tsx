...
> {
    ...
    defaultFilters = () => {
        if (this.state.selectedSite && this.props.filters && this.props.filters[this.state.selectedSite.id]) {
    ...
    render() {
        return (
            <ModalTransition>
                ...
                >
                    <Field label="Select Site" id="select-site" name="select-site" defaultValue="">
                        {(fieldArgs: any) => {
                            return (
                                <Select
                    ...
                    <Field label="Select Filter" id="select-filter" name="select-filter" defaultValue="">
                        {(fieldArgs: any) => {
                            return (
                                <AsyncSelect
                                    {...fieldArgs.fieldProps}
                    ...
                    >
                        <div style={{ display: 'inline-flex', marginRight: '4px', marginLeft: '4px' }}>
                            <Button className="ac-button" isDisabled={!this.state.selectedFilter} onClick={this.onSave}>
                                Save
                            </Button>
                        </div>
                        <div style={{ display: 'inline-flex', marginRight: '4px', marginLeft: '4px' }}>
