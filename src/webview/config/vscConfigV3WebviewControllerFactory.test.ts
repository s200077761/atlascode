...
import { VSCConfigV3WebviewControllerFactory } from './vscConfigV3WebviewControllerFactory';
...
jest.mock('../../lib/webview/controller/config/configV3WebviewController');
jest.mock('../../logger');
jest.mock('../../resources');
jest.mock('../common/getHtmlForView');

describe('VSCConfigV3WebviewControllerFactory', () => {
    let factory: VSCConfigV3WebviewControllerFactory;
    ...
    let mockController: jest.Mocked<ConfigV3WebviewController>;
    ...
    beforeEach(() => {
        ...
        // Mock ConfigV3WebviewController
        mockController = {
            onSitesChanged: jest.fn(),
        } as any;
        (ConfigV3WebviewController as jest.Mock).mockReturnValue(mockController);
        ...
        factory = new VSCConfigV3WebviewControllerFactory(
            mockConfigActionApi,
            mockCommonHandler,
            mockAnalyticsApi,
            settingsUrl,
    ...
    describe('constructor', () => {
        it('should initialize with provided dependencies', () => {
            expect(factory).toBeInstanceOf(VSCConfigV3WebviewControllerFactory);
        });
    });
    ...
    describe('createController', () => {
        it('should create a ConfigV3WebviewController with correct parameters', () => {
            const factoryData: SectionV3ChangeMessage = {
            ...
            expect(ConfigV3WebviewController).toHaveBeenCalledWith(
                mockPostMessage,
                mockConfigActionApi,
                mockCommonHandler,
                Logger.Instance,
        ...
        it('should create a ConfigV3WebviewController without factory data', () => {
